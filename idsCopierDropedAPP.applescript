(* 
	This AppleScript extracts numbers from the names 
    of the received (droped) files and copies 
    the result to the clipboard 

    It should be Exported as Application from "Script Editor"
